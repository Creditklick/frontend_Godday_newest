...
function FileUploadAndShowAllFiles() {
    ...
    return (
        <div className="p-8 bg-gradient-to-br from-green-50 via-green-100 to-green-200 rounded-lg shadow-xl space-y-6 h-screen">
            <Typography variant="h4" gutterBottom className="text-green-800 font-semibold">
              <FolderIcon style={{ fontSize: "35px", color: "#ff9800" }} />   Files in Folder: {folderPath || 'Root'}
            </Typography>
