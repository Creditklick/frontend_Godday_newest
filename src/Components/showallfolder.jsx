...
const handleDeleteFolder = async (folderPath) => {
  ...
  return (
    ...
    <div className="p-8 bg-blue-300 rounded-md">
...

{
      ...
      <h2 className="text-2xl font-semibold text-green-800">  <FolderIcon style={{ fontSize: "35px", color: "#ff9800" }} /> Secure Folder</h2>
      ...
      <div className="my-6 bg-white p-6 rounded-lg shadow-md">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6">
          {files
            .filter(file => file.type === 2) // Only include folders
            .map((file, index) => (
              <div key={index} className="items-center p-4 border rounded-lg bg-green-100 shadow-lg">
                ...
                <div className="w-full space-x-3 flex justify-between">
                  <button
                    ...
                    onClick={()=>openModal(file.name)}
                  >
                   <FolderIcon style={{ fontSize: "35px", color: "#ff9800" }} />  {file.name}
                  </button>
